...
def preprocess(data):
    ...
    # Taken from PIPy_Datalink class
    # preprocessor.data_preprocessed.index = preprocessor.data_preprocessed.index.tz_localize(pytz.utc).tz_convert("pst") # accounts for localtime shift
    # preprocessor.data_preprocessed.index = preprocessor.data_preprocessed.index.tz_localize(None)# Gets rid of extra offset information so can compare with csv data
